...
public class GetAllCycleOperationUseCase extends UseCase<CycleOperation> {

    private CycleOperationRepository repository;

    @Inject
    public GetAllCycleOperationUseCase(ThreadExecutor threadExecutor,
                                       PostExecutionThread postExecutionThread, CycleOperationRepository repository){
    ...
    protected Observable buildUseCaseObservable(CycleOperation... arg) {
        return repository.getCircleOperationList();
    }
}
